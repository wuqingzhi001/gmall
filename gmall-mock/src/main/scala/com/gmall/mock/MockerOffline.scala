package com.gmall.mock

import java.text.SimpleDateFormat
import java.util.UUID

import com.gmall.common.datamodules.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.gmall.mock.utils.{RanOpt, RandomDate, RandomNum, RandomOptions}
